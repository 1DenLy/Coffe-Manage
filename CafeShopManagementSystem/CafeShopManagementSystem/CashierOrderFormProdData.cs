...
namespace CafeShopManagementSystem
{
    class CashierOrderFormProdData
    {
        ...
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Git\cafe2.mdf;Integrated Security=True;Connect Timeout=30;Encrypt=False");
        ...
        public List<CashierOrderFormProdData> availableProductsData()
        {
            ...
            if (connect.State == ConnectionState.Closed)
            {
                try
                {
                    ...
                    {
                        cmd.Parameters.Add("@stats", SqlDbType.NVarChar).Value = "Available";

...
namespace CafeShopManagementSystem
{
    public partial class AdminAddProducts : UserControl
    {
                    ...
                    try
                    {
                        ...
                        using (SqlCommand selectPID = new SqlCommand(selectProdID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Git\CafeShopManagementSystem\Product_Directory\" 
        ...
        private void adminAddProducts_stock_TextChanged(object sender, EventArgs e)
        {
        ...
        private void adminAddProducts_type_SelectedIndexChanged(object sender, EventArgs e)
        {

        ...
        public void displayTodaysIncome()
        {
            if (connect.State == ConnectionState.Closed)
            {
                try
                {
                    ...
                    string selectData = "SELECT sum(CAST(total_price AS FLOAT)) FROM customers WHERE DATE = @date";
        ...
        public void displayTotalIncome()
        {
            if (connect.State == ConnectionState.Closed)
            {
                try
                {
                    ...
                    string selectData = "SELECT SUM(CAST(total_price AS FLOAT)) FROM customers";
